...
uint8NOCODE(setDataStoreReadUser, char * password, char * userid)
uint8NOCODE(setDataStoreWriteUser, char * password, char * userid)
uint8NOCODE(setDataStore,char * password, char * userid, char * filename)
uint8NOCODE(getDataStore,char * password, char * userid, char * filename)
